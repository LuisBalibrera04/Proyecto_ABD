...
CREATE LOGIN L_Asistente WITH PASSWORD = 'Admin@ABD25';
USE GimnasioReservas;
CREATE USER U_Asistente FOR LOGIN L_Asistente;

-- Usuario 2: Contabilidad
CREATE LOGIN L_Contabilidad WITH PASSWORD = 'Contabilidad@ABD25';
USE GimnasioReservas;
CREATE USER U_Contabilidad FOR LOGIN L_Contabilidad;

-- Usuario 3: Solo Lectura
CREATE LOGIN L_Lector WITH PASSWORD = 'Lectura@ABD25';
USE GimnasioReservas;
CREATE USER U_Lector FOR LOGIN L_Lector;

-- Usuario 4: Solo Backups
CREATE LOGIN L_Respaldos WITH PASSWORD = 'Backups@ABD25';
USE GimnasioReservas;
CREATE USER U_Respaldos FOR LOGIN L_Respaldos;
GO
...
CREATE ROLE R_Respaldos;
GRANT BACKUP DATABASE TO R_Respaldos;
GRANT BACKUP LOG TO R_Respaldos;
ALTER ROLE R_Respaldos ADD MEMBER U_Respaldos;